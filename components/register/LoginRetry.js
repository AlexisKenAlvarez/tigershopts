...
const LoginRetry = ({ email }) => {
    ...
    return (
        <>
            ...
            <motion.div variants={primary} initial="exit" animate="start" exit="exit" className="bg-white rounded-3xl w-0 h-full z-3 absolute top-0 right-0 transition-all ease-in-out duration-[0.5s] px-7 pointer-events-none z-30">
