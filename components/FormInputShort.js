    ...
    return (
        <>
            <div className="mt-5">
                ...
                <input {...inputProps} className="bg-inputBg w-full h-12 block mt-2 outline-0 p-2 px-4 text-sm text-slate-700 rounded-md" autoComplete="off"  style={error[props.name] === '' ? {backgroundColor: '#e2f3e7'} : {backgroundColor: '#FCE3E4'}}></input>
            </div>
