const LongButton = (props) => {
    ...
    return (
        <div className="w-full mt-6 rounded-lg flex items-center justify-center p-[1px] bg-greenButton hover:bg-white transition-all ease-in-out duration-300" onClick={onClick}>
