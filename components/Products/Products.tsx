...
const Products: FunctionComponent<Prod> = (props) => {
    ...
    return (
        <section className="min-h-[70vh] pb-40 w-full relative bg-blend-overlay border-t-8 border-t-[#003C14] bg-no-repeat bg-cover" style={{ backgroundImage: `url(${Aerial.src})` }}>
