...
const Products: FunctionComponent<Prod> = (props) => {
    ...
    return (
        <section className="min-h-[70vh] pb-40 w-full relative bg-blend-overlay bg-no-repeat bg-cover border-t-8 border-t-[#0f7a33] overflow-hidden" style={{ backgroundImage: `url(${Aerial.src})` }}>
