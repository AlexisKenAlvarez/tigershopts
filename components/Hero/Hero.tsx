            ...
            <div className="w-full max-w-[1400px] md:mx-[8rem] mx-[2rem] h-[85vh] flex flex-col md: md:flex-row">
                <div className="flex items-center h-full w-full justify-center">
                    <div className="">
                        ...
                        <motion.div initial={{ x: -300, opacity: 0 }} animate={{ x: 0, opacity: 100 }} exit={{x: -300, opacity: 0}} transition={{ duration: 0.7, delay: 0.2 }} className={`md:flex md:ml-2 mt-8 rounded-lg hidden items-center justify-center p-[1px] bg-greenButton hover:bg-white w-40 mx-auto`}>
